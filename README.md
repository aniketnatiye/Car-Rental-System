...
Rent and return cars with real-time availability updates
Calculate total rental cost based on car type and rental duration
Maintain data integrity using OOP principles
Simple menu-driven console interface
Concepts Implemented
Encapsulation using private fields and public methods
Collections Framework with ArrayList for managing data
